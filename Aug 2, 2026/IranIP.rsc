# Provided by A. Moradi | amoradi.ir
#
...
add address=91.246.49.0/24 list=Iran
...
add address=94.183.164.0/22 list=Iran
add address=94.183.171.0/24 list=Iran
add address=94.183.172.0/22 list=Iran
...
add address=94.183.212.0/22 list=Iran
...
add address=94.183.236.0/23 list=Iran
...
add address=103.130.147.0/24 list=Iran
...
add address=130.244.8.84/32 list=Iran
...
add address=188.158.0.0/16 list=Iran
add address=188.159.0.0/17 list=Iran
add address=188.159.128.0/18 list=Iran
add address=188.159.192.0/19 list=Iran
...
add address=204.245.22.24/30 list=Iran
